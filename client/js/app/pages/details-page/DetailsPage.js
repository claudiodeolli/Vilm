...
export default class DetailsPage extends HTMLElement{
    ...
    async #html(){
        ...
        const imgCover = FormatUrlImage.get(500, backdrop_path);
        const imgPoster = FormatUrlImage.get(500, poster_path);
        ...
        html.innerHTML = `
            ...
            <div class="details-page__info">
                ...
                <div class="details-page__info__card">
                    ...
                    <h2 class="details-page__info__card__title">${title}</h2>
                    <div class="details-page__info__card__rating">
                        ...
                        <span class="details-page__info__card__rating__vote">${vote_average}</span>
                    </div>
                </div>
                <div class="details-page__info__overview">
                    <h3 class="details-page__info__overview__title">Overview</h3>
                    <span class="details-page__info__overview__text">${overview}</span>
                </div>
            </div>
        `;
